...
var Toolbar = function Toolbar(props) {
  var toogleContrast = function toogleContrast() {
    if (window.sessionStorage) {
      var contrast = "contrast";
      var current = window.sessionStorage.getItem(contrast);
      window.sessionStorage.setItem(contrast, current !== undefined ? !JSON.parse(current) : false);
    }
  };
...
//# sourceMappingURL=main.e6d117e27a519a5d844c.hot-update.js.map