...
var Toolbar = function Toolbar(props) {
  var toogleContrast = function toogleContrast(init) {
    if (window.sessionStorage) {
      ...
      window.sessionStorage.setItem(contrast, !init || init && current === undefined ? !JSON.parse(current || true) : false);
    }
  };
...
//# sourceMappingURL=main.74a4255ca11f17d689ee.hot-update.js.map