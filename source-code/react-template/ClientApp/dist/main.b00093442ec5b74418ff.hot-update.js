...
var Toolbar = function Toolbar(props) {
  var toogleContrast = function toogleContrast(init) {
    if (window.sessionStorage) {
      ...
      window.sessionStorage.setItem(contrast, !init || init && current === undefined ? !JSON.parse(current || true) : current);
    }
  };
...
//# sourceMappingURL=main.b00093442ec5b74418ff.hot-update.js.map