...
namespace react_template_data.Migrations
{
    ...
    [Migration("20201125144116_ChangeClientToUnitInMasterContext")]
    partial class ChangeClientToUnitInMasterContext
    {
            ...
            modelBuilder.Entity("react_template_data.Data.Master.Unit", b =>
                {
                    ...
                    b.Property<DateTime>("LicenceSince")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp without time zone")
                        .HasDefaultValue(new DateTime(2020, 11, 25, 14, 41, 15, 729, DateTimeKind.Utc).AddTicks(850));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LicenceNo = "default",
                            LicenceSince = new DateTime(2020, 11, 25, 14, 41, 15, 738, DateTimeKind.Utc).AddTicks(4113),
                            Name = "default"
                        });
                });
